...
void PlayerHitMoveBlockX(MoveBlockData archBlock)
{
	PlayerPushOutX(archBlock.posX, archBlock.posY, ARCH_BLOCK_WIDTH, ARCH_BLOCK_HEIGHT, true, true);
}

void PlayerHitMoveBlockY(MoveBlockData archBlock)
{
	bool isHit = PlayerPushOutY(archBlock.posX, archBlock.posY, ARCH_BLOCK_WIDTH, ARCH_BLOCK_HEIGHT, 8.0f);
	...
	if (isHit)
	{
		...
		{
			g_PlayerData.posX += ARCH_BLOCK_SPEED * archBlock.dir;
		}
