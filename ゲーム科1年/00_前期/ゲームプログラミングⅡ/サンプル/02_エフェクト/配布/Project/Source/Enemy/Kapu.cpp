...
void KapuHitPlayer(int index)
{
	...
	// 死亡エフェクト
	PlayAnimationEffect(ENEMY_DEAD, kapu->posX, kapu->posY, ENEMY_KAPU_DEAD_EFFECT_INTERVAL);
...
void KapuHitPlayerBullet(int index)
{
	...
	if (kapu->hp <= 0)
	{
		...
		// 死亡エフェクト
		PlayAnimationEffect(ENEMY_DEAD, kapu->posX + ENEMY_KAPU_DEAD_EFFECT_OFFSET, kapu->posY + ENEMY_KAPU_DEAD_EFFECT_OFFSET, ENEMY_KAPU_DEAD_EFFECT_INTERVAL);
