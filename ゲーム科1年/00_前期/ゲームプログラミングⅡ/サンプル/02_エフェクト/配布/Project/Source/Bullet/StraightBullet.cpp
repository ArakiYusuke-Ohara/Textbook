...
void StraightBulletHitEnemy(int index)
{
	...
	PlayAnimationEffect(PLAYER_NORMAL_SHOT_HIT, effectPosX, effectPosY, HIT_EFFECT_INTERVAL);
...
void StraightBulletHitPlayer(int index)
{
	...
	float effectPosX = bullet->posX;
	float effectPosY = bullet->posY;
	PlayAnimationEffect(ENEMY_BULLET_HIT, effectPosX, effectPosY, HIT_EFFECT_INTERVAL);
}
