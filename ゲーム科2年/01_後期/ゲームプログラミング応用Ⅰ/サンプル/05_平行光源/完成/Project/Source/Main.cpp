...
void GameDraw()
{
	...
	// シェーダーを設定
	ShaderManager::GetInstance()->SetShader(NORMALMESH_DIRLIGHT);
	//ShaderManager::GetInstance()->SetVertexShader(NORMALMESH_DIRLIGHT);
	//ShaderManager::GetInstance()->SetPixelShader(NORMALMESH_DIRLIGHT);
