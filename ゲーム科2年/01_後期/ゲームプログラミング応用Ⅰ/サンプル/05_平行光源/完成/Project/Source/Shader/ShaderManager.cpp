...
void ShaderManager::Load()
{
	...
	m_VSHandles[NORMALMESH_DIRLIGHT] = LoadVertexShader("Data/Shader/NormalMesh_DirLight_VS.vso");

	// ピクセルシェーダーのロード
	m_PSHandles[NORMALMESH_NOLIGHT] = LoadPixelShader("Data/Shader/NormalMesh_NoLight_PS.pso");
	m_PSHandles[NORMALMESH_DIRLIGHT] = LoadPixelShader("Data/Shader/NormalMesh_DirLight_PS.pso");
}
